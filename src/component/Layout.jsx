...
function LogoComponent(){
	return(
		...
		<a href='#' className='text-lg lg:text-3xl  uppercase font-semibold '>the creative80 room</a>	
		</div>
		)
}
...
function MenuComponent(){
	return(
		<div className=' border-b-2  md:border-1   border-red-600 flex justify-between items-center w-screen py-5 md:py-6 sm:py-2 px-7 md:px-0 lg:px-0'>
			<a href="" className=' text-lg md:text-md  lg:text-xl font-semibold uppercase '>the creative80 room</a>
			<button className='md:hidden'><img className='size-8 sm:size-10 ' src={MENUICON} alt=""/></button>
